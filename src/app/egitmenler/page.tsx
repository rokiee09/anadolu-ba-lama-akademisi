      ...
      <section className="section-shell py-16">
        <div className="grid gap-6 lg:grid-cols-[0.8fr_1.2fr]">
          <div className="card-surface min-h-80 p-8">
            ...
            <p className="mt-4 text-3xl font-semibold text-[#2B1B12]">{instructor.name}</p>
            <p className="mt-2 text-amber-300">{instructor.title}</p>
            <div className="mt-8 rounded-3xl border border-[#6B3E26]/10 bg-[#6B3E26]/[0.04] p-6 text-[#6B584D]">
              {instructor.summary}
            </div>
          </div>

          <div className="card-surface p-8">
            <h2 className="text-2xl font-semibold text-[#2B1B12]">Neden guven veriyor?</h2>
